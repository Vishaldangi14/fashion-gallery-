...
$check=$db->get_var("select count(*) from designer_reg where semail='$email'");
					if($check>0)
					{
					...
					$query="insert into designer_reg(sname,sgender,sage,state,city,address,contact,b_name,b_address,semail,spass,status) values('$name','$gen','$age','$state','$city','$address','$contact','$b_name','$b_address','$email','$pass','PENDING')";
						$result=$db->query($query);
							if($result)
								echo "<script>alert('Your details have been submitted!!Wait for the APPROVAL')</script>";
							else
...
<div id="wrapper">
	<div id="menu-wrapper">
		...
		<li class="current_page_item"><a href="designer_reg.php">Designer Registration</a></li>
...
<label for="fname">state</label>
  ...
  <input type="text" id="fname" name="b_name">
  <label for="fname">Boutique Address</label>
  <input type="text" id="fname" name="b_address">
...
<div id="footer">
<p>© 2018 Untitled Inc. All rights reserved. Design and Devloped by Akshay Jain</a>.</p></div>
<!-- end #footer -->
</body>
</html>
